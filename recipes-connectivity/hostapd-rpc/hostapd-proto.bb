DESCRIPTION = "QTI hostapd Proto Library"
...
do_install() {
    install -d ${D}${includedir}/rpc/proto/hostapd
    install -m 0755 ${S}/a2p_gen/gen/*.pb.h ${D}${includedir}/rpc/proto/hostapd
    install -m 0755 ${S}/a2p_gen/*.proto ${D}${includedir}/rpc/proto/hostapd

    install -d ${D}${libdir}
    install -m 0755 ${S}/a2p_gen/*.so.0 ${D}/${libdir}
  
    cd ${D}${libdir}
    ln -s libqti-wifi-hostapd-proto.so.0 libqti-wifi-hostapd-proto.so
}
