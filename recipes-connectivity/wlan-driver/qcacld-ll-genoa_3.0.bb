...
EXTRA_OEMAKE += " WLAN_CFG_OVERRIDE="CONFIG_IPA_DISABLE_OVERRIDE=y CONFIG_QCN7605_PCIE_GOLBAL_RESET_SUPPORT=y CONFIG_GET_DRIVER_MODE=y CONFIG_WLAN_MAX_VDEVS=4""
