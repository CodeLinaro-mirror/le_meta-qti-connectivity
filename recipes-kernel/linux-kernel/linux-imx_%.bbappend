...
SRC_URI += "file://lk-4.14/0001-2748365-cfg80211-Updated-nl80211_commands-to-be-in-sync-with.patch \
           ...
           "
CAF_PATCH_PATH = "https://git.codelinaro.org/clo/la/kernel/nxp/-/commit/"
...
SRC_URI       += "${CAF_PATCH_PATH}10773a7c09b327d02144c7d181e6544b7015ffc7;downloadfilename=${PATCH_NAME_4};md5sum=9c7ff62930f4319d3dce4bc01b60e647 \
                  ${CAF_PATCH_PATH}db8d93a7a355121d49777c059afbca23c53c8628;downloadfilename=${PATCH_NAME_5};md5sum=0b3557374a5acf0965f0bd63ae335d0e \
                 "
...
SRC_URI       += "${CAF_PATCH_PATH}6c900360e7c0df6a4846ac97d7b548d72cd801b0;downloadfilename=${PATCH_NAME_8};md5sum=bf4648f1073f2accc94f44614d87f664"
SRC_URI += "file://lk-4.14/0009-2748379-cfg80211-nl80211-Offload-OWE-processing-to-user-spac.patch"

CAF_PATCH_PATH_REG_SELF = "https://git.codelinaro.org/clo/la/kernel/msm-4.4/-/commit/"
PATCH_NAME_REG_SELF = "reg-qcom-call-regulatory-callback-for-self-managed-hints.patch"
SRC_URI += "${CAF_PATCH_PATH_REG_SELF}31e37a680dcbb02ba41d17972dba0b298cf1983d;downloadfilename=${PATCH_NAME_REG_SELF};md5sum=c79fe89b3fbc3e9b2b578a1d1dcebf0e"
