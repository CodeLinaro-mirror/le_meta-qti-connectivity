...
IMAGE_INSTALL += "wifi-server wifi-someip-service wifi-message wifi-proto"
...
IMAGE_INSTALL += "wpa-supplicant-proto"
IMAGE_INSTALL += "wpa-supplicant-message"
IMAGE_INSTALL += "hostapd-proto"
IMAGE_INSTALL += "hostapd-message"
